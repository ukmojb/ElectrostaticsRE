...
public class TileJumpGenerator extends TileEntity implements ITickable, IEnergyStorage {

    private EnergyStorage storage;

    public TileJumpGenerator() {
        this.storage = new EnergyStorage(1000, ConfigHandler.ElectrostaticRfPerTick, ConfigHandler.ElectrostaticRfPerTick);
    }
